...
CMD dotnet sonarscanner begin /k:"${ESTAFETTE_EXTENSION_PROJECT}" /v:"${ESTAFETTE_BUILD_VERSION}" /d:sonar.branch.name=${ESTAFETTE_GIT_BRANCH} /d:sonar.host.url=${ESTAFETTE_EXTENSION_SONAR_HOST}; \
